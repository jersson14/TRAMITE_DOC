                    ...
                    <div class="row">
                        ...
                        <div class="col-12 form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="chk_externo">
                                    Es trámite externo
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- Input externo -->
                        <div class="col-6 form-group" id="div_dni_input" style="display:none;">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary" id="prueba"><i class="fa fa-search"></i> Busqueda por Reniec</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group clearfix">
                                <div class="icheck-success d-inline">
                                    <!-- Antes aquí había una casilla "Tiene el documento firmado
                                         digitalmente" que solo habilitaba el campo de archivo: era una
                                         declaración del operador y nadie comprobaba nada. Ahora el
                                         servidor verifica de verdad la firma del PDF al elegirlo y el
                                         resultado se pinta en #firma_del_archivo. -->
                        ...
                        <div class="col-12 form-group">
                            ...
                            <input class="form-control" type="file" id="txt_archivo" accept=".pdf"><br>
                            <div class="col-12 form-group">
...
var checkboxes = document.querySelectorAll('.checkbox-card-container input[type=checkbox]');
    ...
    for (var i = 0; i < checkboxes.length; i++) {
     ...
     $("#prueba").click(function() {
            ...
            var dni = $("#txt_dni2").val(); // Cambié de #dni a #txt_dni
...
<script>
    document.getElementById("chk_externo").addEventListener("change", function () {
        if (this.checked) {
            // Mostrar input y ocultar select
            document.getElementById("div_dni_input").style.display = "block";
            document.getElementById("div_dni_select").style.display = "none";
        } else {
            // Mostrar select y ocultar input
            document.getElementById("div_dni_input").style.display = "none";
            document.getElementById("div_dni_select").style.display = "block";
        }
    });
</script>
<style>
  ...
  #chk_externo {
    ...
    height: 22px;
    cursor: pointer;
    accent-color: #007bff; /* Color bonito (azul Bootstrap) */
    border-radius: 5px;
  }
