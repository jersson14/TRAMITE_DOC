        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
              <table id="tabla_cargo" class="table table-striped table-bordered" style="width:100%">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#1FA0E0;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white; text-align:center"><b>REGISTRO DE CARGO</b></h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" onclick="Registrar_Cargo()"><i class="fas fa-save"></i> Registrar</button>
      </div>
    </div>
  </div>
</div>
