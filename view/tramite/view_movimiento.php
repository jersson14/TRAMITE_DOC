                    ...
                    <table id="tabla_tramite" class="table table-striped table-bordered table-modern" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">Plazo</th>                          </tr>
                        </thead>
                    </table>
                  </div>
                </div>
...
<div class="modal fade" id="modal_mas" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div id="lista_atenciones" class="mt-3"></div>
    ...
    $(document).ready(function () {
      listar_tramite();
      Filtros_Bandeja.montar("#filtros_bandeja", "#tabla_tramite", { estado: window.FILTRO_ESTADO_INICIAL || "" });
      window.FILTRO_ESTADO_INICIAL = "";
