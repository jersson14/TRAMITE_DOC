            ...
            <div class="card card-modern">
              ...
              <h3 class="card-title"><i class="fas fa-user"></i>&nbsp;&nbsp;<b>Listado de Usuarios</b></h3>
                ...
                <div class="table-responsive" style="text-align:center">
                  <div class="card-body">
                    <table id="tabla_usuario" class="table table-striped table-bordered table-modern" style="width:100%">
                        <thead>
                            <tr>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-12">
            ...
            <label for="">Usuario(*):</label>
            <input type="text" class="form-control" id="txt_usu_editar" readonly>
          </div>
          <div class="col-12">
            <label for="">Empleado(*):</label>
