...
class ChatAssistant {
    ...
    init() {
        ...
        console.log('Toggle button:', this.chatToggle);
        ...
        this.widget.addEventListener('click', (e) => {
            console.log('Widget clicked, minimized:', this.isMinimized);
    ...
    async sendMessage() {
        ...
        try {
            ...
            if (response.success) {
                ...
                this.addErrorMessage(response.error || 'Error al procesar la solicitud');
            }
