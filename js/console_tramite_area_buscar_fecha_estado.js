...
function listar_seguimiento_tramite(id){
  tbl_seguimiento = $("#tabla_seguimiento").DataTable({
      ...
      "columns":[
        ...
        {"data":"mov_estatus", render: function(data,type,row){ return Render_Estado_Movimiento(data,type,row,false); }},
...
$(function () {
  ...
  Exportaciones_Montar("#exportar_reporte", "fecha_estado", function () {
    var f = { desde: document.getElementById('txtfechainicio').value, hasta: document.getElementById('txtfechafin').value, estado: document.getElementById('select_buscar_estado').value };
    if (!f.desde || !f.hasta) {
